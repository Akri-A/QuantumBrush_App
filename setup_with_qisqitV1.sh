...
main() {
    ...
    printf "  • Qiskit_nature: $(conda run -n quantumbrush python -c 'import qiskit_nature; print(qiskit_nature.__version__)' 2>/dev/null || echo 'Not available')\n"
    printf "  • Qiskit_algorithms: $(conda run -n quantumbrush python -c 'import qiskit_algorithms; print(qiskit_algorithms.__version__)' 2>/dev/null || echo 'Not available')\n"
    echo
